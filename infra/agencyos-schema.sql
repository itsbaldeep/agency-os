...
--
-- Name: marketing_assessments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.marketing_assessments (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    brand_id integer NOT NULL REFERENCES public.brands(id),
    project_id bigint NOT NULL REFERENCES public.projects(id),
    trigger_task_id integer NOT NULL REFERENCES public.tasks(id) ON DELETE RESTRICT,
    run_key text NOT NULL,
    schema_version integer DEFAULT 1 NOT NULL CHECK (schema_version >= 1),
    status text DEFAULT 'queued'::text NOT NULL CHECK (status = ANY (ARRAY['queued'::text, 'collecting'::text, 'synthesizing'::text, 'ready'::text, 'partial'::text, 'failed'::text, 'cancelled'::text])),
    brief_snapshot jsonb DEFAULT '{}'::jsonb NOT NULL,
    brief_version integer DEFAULT 1 NOT NULL CHECK (brief_version >= 1),
    source_manifest jsonb DEFAULT '{}'::jsonb NOT NULL,
    report jsonb,
    validation jsonb,
    prior_assessment_id bigint REFERENCES public.marketing_assessments(id) ON DELETE SET NULL,
    started_at timestamp with time zone,
...
--
-- Name: marketing_assessment_stages; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.marketing_assessment_stages (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    assessment_id bigint NOT NULL REFERENCES public.marketing_assessments(id) ON DELETE CASCADE,
    stage_key text NOT NULL,
    task_id integer NOT NULL REFERENCES public.tasks(id) ON DELETE RESTRICT,
...
--
-- Name: idx_marketing_assessments_brand_project_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_marketing_assessments_brand_project_created ON public.marketing_assessments USING btree (brand_id, project_id, created_at DESC);


--
-- Name: idx_marketing_assessments_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_marketing_assessments_status ON public.marketing_assessments USING btree (status, created_at);


--
-- Name: idx_marketing_assessment_stages_assessment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_marketing_assessment_stages_assessment ON public.marketing_assessment_stages USING btree (assessment_id, status);
