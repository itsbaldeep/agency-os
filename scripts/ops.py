...
def export_configs(destination: Path) -> dict[str, bool]:
    sources = {
        ...
        "codex-config": AGENCY_HOME / ".codex/config.toml",
        "codex-hooks": AGENCY_HOME / ".codex/hooks.json",
        "codex-agents": AGENCY_HOME / ".codex/agents",
        "opencode-config": AGENCY_HOME / ".config/opencode/opencode.jsonc",
        "opencode-agents": AGENCY_HOME / ".config/opencode/agents",
        "opencode-plugins": AGENCY_HOME / ".config/opencode/plugins",
        "agent-traces": STATE_DIR / "agent-traces",
        "firstmate-config": AGENCY_HOME / "tools/firstmate/config",
        "firstmate-captain": AGENCY_HOME / "tools/firstmate/data/captain.md",
        "firstmate-projects": AGENCY_HOME / "tools/firstmate/data/projects.md",
        "firstmate-learnings": AGENCY_HOME / "tools/firstmate/data/learnings.md",
        "firstmate-installation": AGENCY_HOME / "tools/firstmate/data/installation.md",
